include(); async function include() {
    await include_script("/exploration-game.github.io/src/js/index.js");
}

async function include_multiple(name, area) {
    await include_css("/exploration-game.github.io/src/css/" + name + ".css");
    await include_html("/exploration-game.github.io/src/html/content/" + name + ".html", area, true);
    await include_script("/exploration-game.github.io/src/js/" + name + ".js");
}
